...
# g = rp.cartesian_error(cells_matrix, met = 1, phi_function = 0)
...
def nonorth_refine_experiment():
    ...
    rp.grid_refinement_error(cells_matrix, skew_matrix, grid_quality=0, met = 0 , phi_function = 0)
...
def uneven_refine_experiment():
    ...
    rp.grid_refinement_error(cells_matrix, uneven_matrix, grid_quality=1, met = 0, phi_function = 0)
...
def skewness_refine_experiment():
    ...
    rp.grid_refinement_error(cells_matrix, skew_matrix, grid_quality=2, met = 0, phi_function = 0)
