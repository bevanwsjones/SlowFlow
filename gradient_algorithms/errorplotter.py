...
def cartesian_plotter(int_error_array, bound_error_array, h):
    ...
    axs[0, 0].axline((0.01, 0.0001), (0.1, 0.001), color='g', label='$\mathcal{O}(h)$', ls='--')
    ...
    axs[0, 0].set_xlim(0.5 * np.min(h), 1.2 * np.max(h))
    axs[0, 0].set_ylim(0.8 * np.min(int_error_array[:, :, 0]), 1.2 * np.max(int_error_array[:, :, 0]))
    ...
    axs[1, 0].set_xlim(0.5 * np.min(h), 1.2 * np.max(h))
    ...
    axs[0, 1].axline((0.01, 0.0001), (0.1, 0.001), color='g', label='$\mathcal{O}(h)$', ls='--')
    axs[0, 1].axline((0.01, 0.0001), (0.1, 0.01), color='b', label='$\mathcal{O}(h^2)$', ls='--')
    axs[0, 1].set(xlabel='$h$', ylabel='Boundary '+r'$\varepsilon_{x}$')
    axs[0, 1].set_yscale('log')
    axs[0, 1].set_xscale('log')
    axs[0, 1].set_xlim(0.5 * np.min(h), 1.2 * np.max(h))
    ...
    axs[1, 1].axline((0.01, 0.0001), (0.1, 0.001), color='g', label='$\mathcal{O}(h)$', ls='--')
    axs[1, 1].axline((0.01, 0.0001), (0.1, 0.01), color='b', label='$\mathcal{O}(h^2)$', ls='--')
    axs[1, 1].set(xlabel='$h$', ylabel='Boundary '+r'$\varepsilon_{y}$')
    axs[1, 1].set_yscale('log')
    axs[1, 1].set_xscale('log')
    axs[1, 1].set_xlim(0.5 * np.min(h), 1.2 * np.max(h))
    axs[1, 1].set_ylim(0.8 * np.min(bound_error_array[:, :, 1]), 1.2 * np.max(bound_error_array[:, :, 1]))
    axs[1, 1].set_aspect('equal', adjustable='box')
    axs[1, 1].set_title(r'$d )$')

    handles, labels = axs[0, 0].get_legend_handles_labels()
    fig.legend(handles, labels, loc='upper left', ncol=4, bbox_to_anchor=(0.35, 0.1))
    fig.tight_layout()
...
def grid_error_refine(int_error_array, bound_error_array, h, grid_quality, gq = 0):
    ...
    ax2.axline((0.01, 0.0001), (0.1, 0.001), color='g', label='$\mathcal{O}(h)$', ls='--')
    ax2.axline((0.01, 0.0001), (0.1, 0.01), color='b', label='$\mathcal{O}(h^2)$', ls='--')
